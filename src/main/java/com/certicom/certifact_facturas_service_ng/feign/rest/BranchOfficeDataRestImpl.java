...
import com.certicom.certifact_facturas_service_ng.feign.BranchOfficeData;
...
@Service
public class BranchOfficeDataRestImpl implements BranchOfficeData {
    ...
    @Value("${external.services.factura-service-sp.endpoints.api-office-endpoint}")
    private String apiOfficeEndpoint;

    public BranchOfficeDataRestImpl(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    @Override
    public BranchOfficesModel obtenerOficinaPorEmpresaIdYSerieYTipoComprobante(Integer empresaId, String serie, String tipoComprobante) {
        ...
        try {
            ResponseEntity<BranchOfficesModel> response =
                    restTemplate.getForEntity(uriBuilder.toUriString(), BranchOfficesModel.class);
