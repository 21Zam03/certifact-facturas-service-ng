...
import com.certicom.certifact_facturas_service_ng.feign.CuotaPaymentVoucherData;
...
@Service
public class CuotaPaymentVoucherDataRestImpl implements CuotaPaymentVoucherData {
    ...
    @Value("${external.services.factura-service-sp.endpoints.api-cuota-endpoint}")
    private String apiCuotaEndpoint;

    public CuotaPaymentVoucherDataRestImpl(RestTemplate restTemplate) {
