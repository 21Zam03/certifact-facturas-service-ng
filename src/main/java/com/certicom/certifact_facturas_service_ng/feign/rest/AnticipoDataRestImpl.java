...
import com.certicom.certifact_facturas_service_ng.feign.AnticipoData;
...
@Service
public class AnticipoDataRestImpl implements AnticipoData {
    ...
    @Value("${external.services.factura-service-sp.endpoints.api-ancitipo-endpoint}")
    private String apiAnticipoEndpoint;

    public AnticipoDataRestImpl(RestTemplate restTemplate) {
