...
import com.certicom.certifact_facturas_service_ng.feign.DetailPaymentVoucherData;
...
@Service
public class DetailPaymentVoucherDataRestImpl implements DetailPaymentVoucherData {
    ...
    @Value("${external.services.factura-service-sp.endpoints.api-detailpayment-endpoint}")
    private String apiDetailPaymentEndpoint;

    public DetailPaymentVoucherDataRestImpl(RestTemplate restTemplate) {
